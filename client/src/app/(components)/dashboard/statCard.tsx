...
const StatCard = ({
  ...
  return (
    <div className="md:row-span-1 xl:row-span-2 bg-gradient-to-br from-white via-blue-50 to-gray-100 shadow-lg rounded-2xl transition-all duration-500 ease-in-out transform hover:scale-105 hover:shadow-2xl">
      {/* HEADER */}
      <div>
