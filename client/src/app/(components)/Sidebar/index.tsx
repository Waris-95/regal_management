  ...
  return (
    <div className={sidebarClassNames}>
      ...
      <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? "px-5" : "px-8"}`}>
        <div>logo</div>
        <h1 className={`${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl`}>STOCKR</h1>
    ...
    <div className="flex-grow mt-8">
      ...
      <SideBarLink href="/settings" icon={SlidersHorizontal} label="Setting" isCollapsed={isSidebarCollapsed}/>
